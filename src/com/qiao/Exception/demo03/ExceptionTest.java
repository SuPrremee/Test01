package com.qiao.Exception.demo03;

/**
 * @ClassName ExceptionTest
 * @Description TODO
 * @Author liuyuqiao
 * @Data 2022/9/14 10:43 PM
 * @Version 1.0
 **/
 ...
 *  3. 一旦try中的异常对象进行匹配到某一个catch时，就进入catch中进行异常的处理。一旦处理完成跳出当前的try-catch结构(在没有写finally的情况)。
 *      继续执行其后的代码
 ...
 * 体会2：开发中，由于运行时异常比较常见所以我们通常就不针对运行时异常编写try-catch-finally
